...
import AIhome from "../assets/AI2.jpg";
...
const Main = () => {
  ...
  return (
    <>
          ...
          <div className="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 p-0">
            <div className="videoArea area2">
              ...
              >
                <video
                  poster={block}
                  src="https://d1krbhyfejrtpz.cloudfront.net/assets/images/home-new-images/Strategy.mp4"
                  loop
                  preload="auto"
                  muted
                ></video>
                <div className="text text-center">
                  <div>
                    <h3>Empowering Ambitions through Consulting Excellence</h3>
                    <p>Where Expertise Ignites Innovation and Fuels Growth.</p>
          ...
          <div className="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 p-0">
            <div className="videoArea area2">
              ...
              >
                <video
                  poster={block2}
                  src="https://d1krbhyfejrtpz.cloudfront.net/assets/images/home-new-images/mobility.mp4"
                  loop
                  preload="auto"
                  muted
                ></video>
                <div className="text text-center">
                  <div>
                    <h3>Elevate Progress with Cloud-Led Innovation</h3>
                    <p>Unlock Your Cloud Potential and Transform Your Business.</p>
                    <button className="btn-primary">Learn More</button>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 p-0">
            <div className="videoArea area2">
              ...
              >
                <video
                  poster={block3}
                  src="https://d1krbhyfejrtpz.cloudfront.net/assets/images/home-new-images/Ai-4.mp4"
                  loop
                  preload="auto"
                  muted
                ></video>
                <div className="text text-center">
                  <div>
                    <h3>Engineering the Path from Present to Potential.</h3>
                    <p>Turning Vision into Reality with Forward-Thinking Solutions.</p>
                    <button className="btn-primary">Learn More</button>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 p-0">
            <div className="videoArea area2">
              ...
              >
                ...
                <div className="text text-center">
                  <div>
                    <h3>Igniting the Next Era of AI-Driven Innovation</h3>
                    <p>Accelerating Enterprise Transformation with End-to-End AI Solutions.</p>
                    <button className="btn-primary">Learn More</button>
                  </div>
                </div>
              </div>
      ...
      {/* Zigzag Section */}
      <section className="zigzack padd80" id="four">
      ...
      {/* Zigzag Section 1 */}
      <section className="zigzack1 padd80">
        <div className="container">
      ...
      <section className="casestudy1 padd80">
        <div className="container">
      ...
      {/* Partners Section */}
      <section className="inquiry pt-5 padd70" id="eight">
        <div className="container">
          <h2 className="mb-5">Have any inquiry?</h2>
          <div className="row">
            <div className="col-xxl-10 col-xl-10 col-lg-12 col-md-8 col-sm-9 col-12 mx-auto">
